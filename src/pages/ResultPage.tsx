...
export default function ResultPage() {
  ...
  return (
    <main className="p-6 max-w-xl mx-auto text-center">
      <h2 className="text-3xl font-bold mb-8">Assessment Result</h2>
      <div className="bg-white shadow-card rounded-xl p-8 ring-1 ring-gray-100">
      ...
      <Link to="/" className="inline-block mt-8">
        <button className="bg-brand-500 hover:bg-brand-600 text-white font-semibold rounded-md px-8 py-2 shadow-card">Retake Test</button>
      </Link>
    </main>
  );
}